...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        //If the _entree is not null (i.e. the user already selected an entree, but changed their choice),
        // set the previousEntreePrice to the current _entree's price.
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        if(_accompaniment.value != null){
            previousEntreePrice = _accompaniment.value!!.price
        }
    ...
    fun calculateTaxAndTotal() {
        ...
        val calculatedTax = _subtotal.value?.times(taxRate)
        _tax.value = calculatedTax
        // set the total based on the subtotal and _tax.value.
        _total.value = _subtotal.value?.plus(calculatedTax!!)
    }
